...
import Product1 from "../../Assests/06s.png"
import Product2 from "../../Assests/beverages.png"
import Product3 from "../../Assests/cart-03.png"
  ...
  return (
...

    {
        dummyProducts?.map((product, index)=> {
            ...
            return(
              <Card  key={index} sx={{padding:"10px", cursor:"pointer", minHeight:"180px", width:"250px"}}>
        <Box>
